 ...
 * 
 * This AI has been made simpler to make it easier to defeat
 * 
 * @author Logan Grier
 * @version 15/01/2015
 */
public class AiRegular extends Player
{
	private class DetermineTileValue
	{
		...
		public double main(int[] tileCoordinate, boolean keepTile)
		{
			...
			// this player
			contructiveTileValue += (numberOfAiControlled * numberOfAiControlled)
					* tiles.length;
	 ...
	 */
	public AiRegular(int playerNumber, LogicBoard board)
	{
		super(playerNumber);
		this.board = board;
	...
	private void evaluateOffensiveMoves()
	{
		...
		for (int target = 0; target < offensiveMoves.size(); target++)
		{
			...
			offensiveMoves.get(target).desirability = tileValue/numberOfUnitsRequiredOffence;
